...
6. **Use the CV** sheets as reference_*
...
* To register a model for inclusion in CMIP7 the Essential Model Documentation (EMD) must be provided. The registration form, and associated
  ...
  a spreadsheet will be made available. Note that this spreadsheet cannot be used for submission of the EMD — completion of the github form _will be
  required_.
...
Work is underway to update ESGF’s client publishing suite - _esgpublish_, and dependent on tools (e.g., _esgdrs_ and _esgmapfile_) in order to
