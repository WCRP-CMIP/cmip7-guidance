---
layout: default
title: "Experiment Setup and Forcings Guidance: esm-scen7-vl-AQ"
---

# Experiment Setup and Forcings Guidance: esm-scen7-vl-AQ
...
(BC, OC, NH3, SO2) evolve as in `esm-scen7-h`.
All other forcings evolve as in `esm-scen7-vl`.
Requires interactive chemistry.
Models without interactive chemistry should run `esm-scen7-vl-Aer` instead.
...
- [esm-scen7-vl-Aer](./esm-scen7-vl-aer.md) is the corresponding non-interactive-chemistry experiment for models that do
  not include interactive chemistry.
- [scen7-vl-AQ](./scen7-vl-aq.md) is the concentration-driven counterpart to this emissions-driven experiment.

## Experiment set up

### Parent experiment and branching

The esm-scen7-vl-AQ experiment branches from the [esm-hist](./esm-hist.md) experiment (part of [CMIP](./index.md#cmip)).
...
The esm-scen7-vl-AQ experiment is a transient forcings experiment.
...
All data is described on the [scen7-vl-AQ](./scen7-vl-aq.md) experiment page.
