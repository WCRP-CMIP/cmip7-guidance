---
layout: default
title: "Experiment Setup and Forcings Guidance: piClim-NOx"
---
...
The piClim-NOx experiment branches from the [piControl](./picontrol.md) experiment (part of [CMIP](./index.md#cmip)).
...
The piClim-NOx experiment is a fixed forcings experiment.
...
- for anthropogenic emissions, use the forcings from [historical](./historical.md) but apply the 2021 nitrogen oxide
  (NO<sub>x</sub>) emissions value on repeat and the 1850 value on repeat for all other species
- for biomass burning emissions, use the forcings from [historical](./historical.md) but apply the 2021 nitrogen oxide
  (NO<sub>x</sub>) emissions value on repeat and the 1850 value on repeat for all other species
