...
Same as `piClim-control`, except nitrous oxide (NOx) emissions use present-day values (2021 in CMIP7).
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:DRES-CMIP-BB4CMIP7-2-0,UofMD-landState-3-1-1,UofMD-landState-3-1-2,CR-CMIP-1-0-0,UOEXETER-CMIP-2-2-1,FZJ-CMIP-ozone-1-2,FZJ-CMIP-nitrogen-1-2,SOLARIS-HEPPA-CMIP-4-6,PIK-CMIP-1-0-1,CEDS-CMIP-2025-04-18,CEDS-CMIP-2025-04-18-supplemental
