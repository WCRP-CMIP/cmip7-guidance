---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-ln-ext"
---

# Experiment Setup and Forcings Guidance: scen7-ln-ext

Extension of `scen7-ln` beyond 2100.
...
- [esm-scen7-ln-ext](./esm-scen7-ln-ext.md) is the emissions-driven counterpart to this concentration-driven experiment.

## Experiment set up

### Parent experiment and branching

The scen7-ln-ext experiment branches from the [scen7-ln](./scen7-ln.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [scen7-ln](./scen7-ln.md) at 2100-12-31.
...
The scen7-ln-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [scen7-ln](./scen7-ln.md) but hold forcings constant at 2100
  levels
- for ozone, use the forcings from [scen7-ln](./scen7-ln.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [scen7-ln](./scen7-ln.md) but hold forcings constant at 2100 levels
...
- biomass burning emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-ln-ext-1-1-1
    - further guidance:
...
- greenhouse gas concentrations
    - recommended source IDs: CR-ln-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-ln-ext-1-0-0
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-ln-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-ln-ext-1-1-1,IIASA-IAMC-ln-ext-1-1-2,PIK-ln-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
