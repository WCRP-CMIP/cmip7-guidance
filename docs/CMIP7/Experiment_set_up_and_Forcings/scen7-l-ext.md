---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-l-ext"
---

# Experiment Setup and Forcings Guidance: scen7-l-ext

Extension of `scen7-l` beyond 2100.
...
The scen7-l-ext experiment branches from the [scen7-l](./scen7-l.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [scen7-l](./scen7-l.md) at 2100-12-31.
...
The scen7-l-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [scen7-l](./scen7-l.md) but hold forcings constant at 2100
  levels
- for ozone, use the forcings from [scen7-l](./scen7-l.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [scen7-l](./scen7-l.md) but hold forcings constant at 2100 levels
...
- greenhouse gas concentrations
    - recommended source IDs: CR-l-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-l-ext-1-0-0
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-l-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-l-ext-1-1-1,PIK-l-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
