---
layout: default
title: "Experiment Setup and Forcings Guidance: esm-scen7-ln-ext"
---

# Experiment Setup and Forcings Guidance: esm-scen7-ln-ext

Extension of `esm-scen7-ln` beyond 2100.
...
- [scen7-ln-ext](./scen7-ln-ext.md) is the concentration-driven counterpart to this emissions-driven experiment.

## Experiment set up

### Parent experiment and branching

The esm-scen7-ln-ext experiment branches from the [esm-scen7-ln](./esm-scen7-ln.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [esm-scen7-ln](./esm-scen7-ln.md) at 2100-12-31.
...
The esm-scen7-ln-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [esm-scen7-ln](./esm-scen7-ln.md) but hold forcings constant
  at 2100 levels
- for ozone, use the forcings from [esm-scen7-ln](./esm-scen7-ln.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [esm-scen7-ln](./esm-scen7-ln.md) but hold forcings constant at 2100
  levels
...
- greenhouse gas concentrations
    - recommended source IDs: CR-esm-ln-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-esm-ln-ext-1-0-0
    - further guidance:
...
EXPERIMENT_NAME="esm-scen7-ln-ext"
