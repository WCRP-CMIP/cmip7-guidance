---
layout: default
title: "Experiment Setup and Forcings Guidance: esm-scen7-l-ext"
---

# Experiment Setup and Forcings Guidance: esm-scen7-l-ext

Extension of `esm-scen7-l` beyond 2100.
...
The esm-scen7-l-ext experiment branches from the [esm-scen7-l](./esm-scen7-l.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [esm-scen7-l](./esm-scen7-l.md) at 2100-12-31.
...
The esm-scen7-l-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [esm-scen7-l](./esm-scen7-l.md) but hold forcings constant at
  2100 levels
- for ozone, use the forcings from [esm-scen7-l](./esm-scen7-l.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [esm-scen7-l](./esm-scen7-l.md) but hold forcings constant at 2100
  levels
...
- anthropogenic emissions
    ...
    - notes: the aviation emissions should come from `IIASA-IAMC-l-ext-1-1-2`.
      ...
      Please follow this pull request to track progress of the publication of the `IIASA-IAMC-l-ext-1-1-2` aviation
...
- greenhouse gas concentrations
    - recommended source IDs: CR-esm-l-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-esm-l-ext-1-0-0
    - further guidance:
...
EXPERIMENT_NAME="esm-scen7-l-ext"
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-l-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-l-ext-1-1-1,IIASA-IAMC-l-ext-1-1-2,PIK-esm-l-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
