...
- for stratospheric aerosol forcing, use the forcings from [esm-scen7-m](./esm-scen7-m.md) but hold forcings constant at
  2100 levels
- for ozone, use the forcings from [esm-scen7-m](./esm-scen7-m.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [esm-scen7-m](./esm-scen7-m.md) but hold forcings constant at 2100
  levels
...
- greenhouse gas concentrations
    - recommended source IDs: CR-esm-m-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-esm-m-ext-1-0-0
    - further guidance:
...
EXPERIMENT_NAME="esm-scen7-m-ext"
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-m-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-m-ext-1-1-1,IIASA-IAMC-m-ext-1-1-2,PIK-esm-m-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
