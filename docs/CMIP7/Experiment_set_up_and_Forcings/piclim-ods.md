---
layout: default
title: "Experiment Setup and Forcings Guidance: piClim-ODS"
---

# Experiment Setup and Forcings Guidance: piClim-ODS
...
- ozone-depleting substance concentrations
...
`piClim-ODS` branches from the [piControl](./picontrol.md) simulation (part of [CMIP](./index.md#cmip)).
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CEDS-CMIP-2025-04-18,CEDS-CMIP-2025-04-18-supplemental,DRES-CMIP-BB4CMIP7-2-0,UofMD-landState-3-1-1,UofMD-landState-3-1-2,UOEXETER-CMIP-2-2-1,FZJ-CMIP-ozone-1-2,FZJ-CMIP-nitrogen-1-2,SOLARIS-HEPPA-CMIP-4-6,PIK-CMIP-1-0-1,CR-CMIP-1-0-0
