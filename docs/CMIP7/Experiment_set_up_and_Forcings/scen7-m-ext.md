---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-m-ext"
---

# Experiment Setup and Forcings Guidance: scen7-m-ext

Extension of `scen7-m` beyond 2100.
...
The scen7-m-ext experiment branches from the [scen7-m](./scen7-m.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [scen7-m](./scen7-m.md) at 2100-12-31.
...
The scen7-m-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [scen7-m](./scen7-m.md) but hold forcings constant at 2100
  levels
- for ozone, use the forcings from [scen7-m](./scen7-m.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [scen7-m](./scen7-m.md) but hold forcings constant at 2100 levels
...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-m-ext-1-1-1, IIASA-IAMC-m-ext-1-1-2
    - notes: the aviation emissions should come from `IIASA-IAMC-m-ext-1-1-2`.
      `IIASA-IAMC-m-ext-1-1-2` was released quite late and the impact of the change is likely to be small, so if you
      have simulations based on `IIASA-IAMC-m-ext-1-1-1`, you do not need to re-run them.
      Please follow this pull request to track progress of the publication of the `IIASA-IAMC-m-ext-1-1-2` aviation
...
- greenhouse gas concentrations
    - recommended source IDs: CR-m-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-m-ext-1-0-0
    - further guidance:
...
```json
{
    "anthropogenic-slcf-co2-emissions": {
        ...
        "recommended_versions": [
            "IIASA-IAMC-1-1-1",
            "IIASA-IAMC-m-ext-1-1-1",
            "IIASA-IAMC-m-ext-1-1-2"
        ],
        "acceptable_versions": []
    },
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-m-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-m-ext-1-1-1,IIASA-IAMC-m-ext-1-1-2,PIK-m-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
