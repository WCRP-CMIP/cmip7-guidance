---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-ln"
---

# Experiment Setup and Forcings Guidance: scen7-ln
...
Run with prescribed carbon dioxide concentrations (for prescribed carbon dioxide emissions, see `esm-scen7-ln`).
...
- [esm-scen7-ln](./esm-scen7-ln.md) is the emissions-driven counterpart to this concentration-driven experiment.

## Experiment set up

### Parent experiment and branching

The scen7-ln experiment branches from the [historical](./historical.md) experiment (part of [CMIP](./index.md#cmip)).
...
The scen7-ln experiment is a transient forcings experiment.
...
- biomass burning emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-ln-1-1-1
    - further guidance:
...
- greenhouse gas concentrations
    - recommended source IDs: CR-ln-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-ln-1-0-0
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-ln-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-ln-1-1-1,IIASA-IAMC-ln-1-1-2,PIK-ln-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2
