...
The abrupt CO<sub>2</sub> quadrupling experiment is a simple branch from the [piControl simulation](./picontrol.md).

After branching, the atmospheric CO<sub>2</sub> concentrations should be set to four times the CO<sub>2</sub>
concentrations used in the piControl experiment.

### Parent experiment and branching

The abrupt-4xCO2 experiment branches from the [piControl](./picontrol.md) experiment (part of [CMIP](./index.md#cmip)).
