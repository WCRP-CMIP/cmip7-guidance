---
layout: default
title: "Experiment Setup and Forcings Guidance: esm-scen7-h-ext"
---

# Experiment Setup and Forcings Guidance: esm-scen7-h-ext

Extension of `esm-scen7-h` beyond 2100.
...
- [scen7-h-ext](./scen7-h-ext.md) is the concentration-driven counterpart to this emissions-driven experiment.

## Experiment set up

### Parent experiment and branching

The esm-scen7-h-ext experiment branches from the [esm-scen7-h](./esm-scen7-h.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [esm-scen7-h](./esm-scen7-h.md) at 2100-12-31.
...
The esm-scen7-h-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [esm-scen7-h](./esm-scen7-h.md) but hold forcings constant at
  2100 levels
- for ozone, use the forcings from [esm-scen7-h](./esm-scen7-h.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [esm-scen7-h](./esm-scen7-h.md) but hold forcings constant at 2100
  levels
...
- greenhouse gas concentrations
    - recommended source IDs: CR-esm-h-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-esm-h-ext-1-0-0
    - further guidance:
...
EXPERIMENT_NAME="esm-scen7-h-ext"
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-h-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-h-ext-1-1-1,IIASA-IAMC-h-ext-1-1-2,PIK-esm-h-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UofMD-landState-h-ext-3-1
