---
layout: default
title: "Experiment Setup and Forcings Guidance: abrupt-0p5xCO2"
---
...
The abrupt CO<sub>2</sub> halving experiment is a simple branch from the [piControl simulation](./picontrol.md).

After branching, the atmospheric CO<sub>2</sub> concentrations should be set to half the CO<sub>2</sub> concentrations
used in the piControl experiment.

### Parent experiment and branching

The abrupt-0p5xCO2 experiment branches from the [piControl](./picontrol.md) experiment (part of
[CMIP](./index.md#cmip)).
...
The abrupt-0p5xCO2 experiment is a fixed forcings experiment.
...
- for greenhouse gas concentrations, use the forcings from [piControl](./picontrol.md) but halve the CO<sub>2</sub>
  concentrations
