...
The `scen7-vl-AQ` simulation is a variant of the `scen7-vl` simulation.

The anthropogenic non-CH4 tropospheric ozone precursor emissions, aerosols and aerosol precursor emissions should evolve
as in the `scen7-h` simulation.

All other forcings should evolve as in `scen7-vl`.

`scen7-vl-AQ` is for models that include interactive chemistry.
...
`scen7-vl-AQ` branches from the [historical](./historical.md) simulation (part of [CMIP](./index.md#cmip)).
...
The `scen7-vl-AQ` experiment is a time-varying forcings experiment, combining anthropogenic non-CH4 tropospheric ozone
precursor emissions, aerosols and aerosol precursor emissions from the `scen7-h` simulation with all other forcings from
the `scen7-vl` simulation.
...
forcing is the same as for the `scen7-h` simulation.
