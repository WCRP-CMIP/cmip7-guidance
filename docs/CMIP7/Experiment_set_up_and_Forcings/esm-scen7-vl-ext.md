---
layout: default
title: "Experiment Setup and Forcings Guidance: esm-scen7-vl-ext"
---

# Experiment Setup and Forcings Guidance: esm-scen7-vl-ext

Extension of `esm-scen7-vl` beyond 2100.
...
- [scen7-vl-ext](./scen7-vl-ext.md) is the concentration-driven counterpart to this emissions-driven experiment.

## Experiment set up

### Parent experiment and branching

The esm-scen7-vl-ext experiment branches from the [esm-scen7-vl](./esm-scen7-vl.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [esm-scen7-vl](./esm-scen7-vl.md) at 2100-12-31.
...
The esm-scen7-vl-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [esm-scen7-vl](./esm-scen7-vl.md) but hold forcings constant
  at 2100 levels
- for ozone, use the forcings from [esm-scen7-vl](./esm-scen7-vl.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [esm-scen7-vl](./esm-scen7-vl.md) but hold forcings constant at 2100
  levels
...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-vl-ext-1-1-1, IIASA-IAMC-vl-ext-1-1-2
    - notes: the aviation emissions should come from `IIASA-IAMC-vl-ext-1-1-2`.
      `IIASA-IAMC-vl-ext-1-1-2` was released quite late and the impact of the change is likely to be small, so if you
      have simulations based on `IIASA-IAMC-vl-ext-1-1-1`, you do not need to re-run them.
    - further guidance:
...
- biomass burning emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-vl-ext-1-1-1
    - further guidance:
...
- land use
    - recommended source IDs: UofMD-landState-vl-ext-3-1
    - further guidance:
...
- greenhouse gas concentrations
    - recommended source IDs: CR-esm-vl-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-esm-vl-ext-1-0-0
    - further guidance:
...
```json
{
    "anthropogenic-slcf-co2-emissions": {
        ...
        "recommended_versions": [
            "IIASA-IAMC-1-1-1",
            "IIASA-IAMC-vl-ext-1-1-1",
            "IIASA-IAMC-vl-ext-1-1-2"
        ],
        "acceptable_versions": []
    },
...
EXPERIMENT_NAME="esm-scen7-vl-ext"
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-vl-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-vl-ext-1-1-1,IIASA-IAMC-vl-ext-1-1-2,PIK-esm-vl-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UofMD-landState-vl-ext-3-1
