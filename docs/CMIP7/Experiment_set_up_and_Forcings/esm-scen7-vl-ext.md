...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-esm-vl-ext-1-1-1
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-vl-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-esm-vl-ext-1-1-1,PIK-esm-vl-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
