...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-h-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-h-ext-1-1-1,IIASA-IAMC-h-ext-1-1-2,PIK-h-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
