...
- [esm-scen7-vl](./esm-scen7-vl.md) is the emissions-driven counterpart to this concentration-driven experiment.

## Experiment set up

### Parent experiment and branching

The scen7-vl experiment branches from the [historical](./historical.md) experiment (part of [CMIP](./index.md#cmip)).
...
The scen7-vl experiment is a transient forcings experiment.
...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-vl-1-1-1, IIASA-IAMC-vl-1-1-2
    - notes: the aviation emissions should come from `IIASA-IAMC-vl-1-1-2`.
      `IIASA-IAMC-vl-1-1-2` was released quite late and the impact of the change is likely to be small, so if you have
      simulations based on `IIASA-IAMC-vl-1-1-1`, you do not need to re-run them.
    - further guidance:
...
- biomass burning emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-vl-1-1-1
    - further guidance:
...
- land use
    - recommended source IDs: UofMD-landState-vl-3-1-1
    - acceptable source IDs: UofMD-landState-vl-3-1
    - further guidance:
...
- greenhouse gas concentrations
    - recommended source IDs: CR-vl-1-1-0
    - further guidance:
...
- ozone
    - recommended source IDs: FZJ-CMIP-ozone-vl-1-0
    - further guidance:
...
- nitrogen deposition
    - recommended source IDs: FZJ-CMIP-nitrogen-vl-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-vl-1-0-0
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-vl-1-1-0,FZJ-CMIP-nitrogen-vl-1-0,FZJ-CMIP-ozone-vl-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-vl-1-1-1,IIASA-IAMC-vl-1-1-2,PIK-vl-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2,UofMD-landState-vl-3-1-1
