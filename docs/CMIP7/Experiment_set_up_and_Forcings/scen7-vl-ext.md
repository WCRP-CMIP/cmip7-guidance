---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-vl-ext"
---

# Experiment Setup and Forcings Guidance: scen7-vl-ext

Extension of `scen7-vl` beyond 2100.
...
- [esm-scen7-vl-ext](./esm-scen7-vl-ext.md) is the emissions-driven counterpart to this concentration-driven experiment.

## Experiment set up

### Parent experiment and branching

The scen7-vl-ext experiment branches from the [scen7-vl](./scen7-vl.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [scen7-vl](./scen7-vl.md) at 2100-12-31.
...
The scen7-vl-ext experiment uses a mix of fixed and transient forcings.
...
- for stratospheric aerosol forcing, use the forcings from [scen7-vl](./scen7-vl.md) but hold forcings constant at 2100
  levels
- for ozone, use the forcings from [scen7-vl](./scen7-vl.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [scen7-vl](./scen7-vl.md) but hold forcings constant at 2100 levels
...
- greenhouse gas concentrations
    - recommended source IDs: CR-vl-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-vl-ext-1-0-0
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-vl-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-vl-ext-1-1-1,IIASA-IAMC-vl-ext-1-1-2,PIK-vl-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UofMD-landState-vl-ext-3-1
