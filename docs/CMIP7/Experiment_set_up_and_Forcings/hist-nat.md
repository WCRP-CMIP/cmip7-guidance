---
layout: default
title: "Experiment Setup and Forcings Guidance: hist-nat"
---

# Experiment Setup and Forcings Guidance: hist-nat

Response to historical natural forcing (with extension using forcings from the `m` scenario simulation).
...
The hist-nat experiment branches from the [piControl](./picontrol.md) experiment (part of [CMIP](./index.md#cmip)).
...
- [historical](./historical.md) for stratospheric aerosol forcing, solar
- [scen7-m](./scen7-m.md) for stratospheric aerosol forcing, solar
- [piControl](./picontrol.md) for anthropogenic emissions, biomass burning emissions, land use, greenhouse gas
  concentrations, aerosol optical properties, population density, ozone, nitrogen deposition
