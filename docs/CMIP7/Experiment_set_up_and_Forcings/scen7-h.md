---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-h"
---

# Experiment Setup and Forcings Guidance: scen7-h
...
Run with prescribed carbon dioxide concentrations (for prescribed carbon dioxide emissions, see `esm-scen7-h`).
...
- [esm-scen7-h](./esm-scen7-h.md) is the emissions-driven counterpart to this concentration-driven experiment.

## Experiment set up

### Parent experiment and branching

The scen7-h experiment branches from the [historical](./historical.md) experiment (part of [CMIP](./index.md#cmip)).
...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-h-1-1-1, IIASA-IAMC-h-1-1-2
    - notes: the aviation emissions should come from `IIASA-IAMC-h-1-1-2`.
      `IIASA-IAMC-h-1-1-2` was released quite late and the impact of the change is likely to be small, so if you have
      simulations based on `IIASA-IAMC-h-1-1-1`, you do not need to re-run them.
    - further guidance:
...
- biomass burning emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-h-1-1-1
    - further guidance:
...
- greenhouse gas concentrations
    - recommended source IDs: CR-h-1-1-0
    - further guidance:
...
- ozone
    - recommended source IDs: FZJ-CMIP-ozone-h-1-0
    - further guidance:
...
- nitrogen deposition
    - recommended source IDs: FZJ-CMIP-nitrogen-h-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-h-1-0-0
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-h-1-1-0,FZJ-CMIP-nitrogen-h-1-0,FZJ-CMIP-ozone-h-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-h-1-1-1,IIASA-IAMC-h-1-1-2,PIK-h-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2,UofMD-landState-h-3-1-1
