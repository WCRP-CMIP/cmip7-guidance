---
layout: default
title: "Experiment Setup and Forcings Guidance: esm-scen7-hl"
---
...
The esm-scen7-hl experiment branches from the [esm-hist](./esm-hist.md) experiment (part of [CMIP](./index.md#cmip)).
...
The esm-scen7-hl experiment is a transient forcings experiment.
...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-esm-hl-1-1-1, IIASA-IAMC-esm-hl-1-1-2
    - notes: the aviation emissions should come from `IIASA-IAMC-esm-hl-1-1-2`.
      `IIASA-IAMC-esm-hl-1-1-2` was released quite late and the impact of the change is likely to be small, so if you
      have simulations based on `IIASA-IAMC-esm-hl-1-1-1`, you do not need to re-run them (but note that the extensions
...
- greenhouse gas concentrations
    - recommended source IDs: CR-esm-hl-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-esm-hl-1-0-0
    - further guidance:
...
```json
{
    "anthropogenic-slcf-co2-emissions": {
        ...
        "recommended_versions": [
            "IIASA-IAMC-1-1-1",
            "IIASA-IAMC-esm-hl-1-1-1",
            "IIASA-IAMC-esm-hl-1-1-2"
        ],
        "acceptable_versions": []
    },
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-hl-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-esm-hl-1-1-1,IIASA-IAMC-esm-hl-1-1-2,PIK-esm-hl-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2
