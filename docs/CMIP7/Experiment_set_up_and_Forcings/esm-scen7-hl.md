...
- [scen7-hl](./scen7-hl.md) is the concentration-driven counterpart to this emissions-driven experiment.
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-hl-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-hl-1-1-1,IIASA-IAMC-hl-1-1-2,PIK-esm-hl-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2
