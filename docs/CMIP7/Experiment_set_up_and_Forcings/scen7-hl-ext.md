---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-hl-ext"
---

# Experiment Setup and Forcings Guidance: scen7-hl-ext

Extension of `scen7-hl` beyond 2100.
...
- [esm-scen7-hl-ext](./esm-scen7-hl-ext.md) is the emissions-driven counterpart to this concentration-driven experiment.

## Experiment set up

### Parent experiment and branching

The scen7-hl-ext experiment branches from the [scen7-hl](./scen7-hl.md) experiment (part of
[ScenarioMIP](./index.md#scenariomip)).
The parent experiment's MIP era is [CMIP7](https://wcrp-cmip.org/CMIP7).

Branch from [scen7-hl](./scen7-hl.md) at 2100-12-31.
...
- for stratospheric aerosol forcing, use the forcings from [scen7-hl](./scen7-hl.md) but hold forcings constant at 2100
  levels
- for ozone, use the forcings from [scen7-hl](./scen7-hl.md) but hold forcings constant at 2100 levels
- for nitrogen deposition, use the forcings from [scen7-hl](./scen7-hl.md) but hold forcings constant at 2100 levels
...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-hl-ext-1-1-1, IIASA-IAMC-hl-ext-1-1-2
    - notes: the aviation emissions should come from `IIASA-IAMC-hl-ext-1-1-2`.
      `IIASA-IAMC-hl-ext-1-1-2` was released quite late and the impact of the change is likely to be small, so if you
      have simulations based on `IIASA-IAMC-hl-ext-1-1-1`, you do not need to re-run them.
    - further guidance:
...
- biomass burning emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-hl-ext-1-1-1
    - further guidance:
...
- greenhouse gas concentrations
    - recommended source IDs: CR-hl-ext-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-hl-ext-1-0-0
    - further guidance:
...
```json
{
    "anthropogenic-slcf-co2-emissions": {
        ...
        "recommended_versions": [
            "IIASA-IAMC-1-1-1",
            "IIASA-IAMC-hl-ext-1-1-1",
            "IIASA-IAMC-hl-ext-1-1-2"
        ],
        "acceptable_versions": []
    },
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-hl-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-hl-ext-1-1-1,IIASA-IAMC-hl-ext-1-1-2,PIK-hl-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
