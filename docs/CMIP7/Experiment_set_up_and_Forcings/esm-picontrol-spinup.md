...
- [piControl-spinup](./picontrol-spinup.md) is the concentration-driven counterpart to this emissions-driven experiment.

## Experiment set up

The emissions-driven pre-industrial control spin-up simulation uses piControl forcings (see [forcings](#forcings)).
