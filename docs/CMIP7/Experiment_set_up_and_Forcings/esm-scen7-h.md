...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-1-1-1, IIASA-IAMC-esm-h-1-1-1, IIASA-IAMC-esm-h-1-1-2
    - notes: the aviation emissions should come from `IIASA-IAMC-esm-h-1-1-2`.
      `IIASA-IAMC-esm-h-1-1-2` was released quite late and the impact of the change is likely to be small, so if you
      have simulations based on `IIASA-IAMC-esm-h-1-1-1`, you do not need to re-run them (but note that the extensions
...
- greenhouse gas concentrations
    - recommended source IDs: CR-esm-h-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-esm-h-1-0-0
    - further guidance:
...
```json
{
    "anthropogenic-slcf-co2-emissions": {
        ...
        "recommended_versions": [
            "IIASA-IAMC-1-1-1",
            "IIASA-IAMC-esm-h-1-1-1",
            "IIASA-IAMC-esm-h-1-1-2"
        ],
        "acceptable_versions": []
    },
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-h-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-esm-h-1-1-1,IIASA-IAMC-esm-h-1-1-2,PIK-esm-h-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2
