...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-esm-h-1-1-1, IIASA-IAMC-1-1-1
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-h-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-esm-h-1-1-1,PIK-esm-h-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2
