...
- anthropogenic emissions
    - recommended source IDs: IIASA-IAMC-ml-1-1-1, IIASA-IAMC-1-1-1
    - further guidance:
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-ml-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-ml-1-1-1,PIK-ml-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6,UOEXETER-ScenarioMIP-2-2-2
