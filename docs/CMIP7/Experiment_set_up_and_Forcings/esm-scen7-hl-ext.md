...
- [scen7-hl-ext](./scen7-hl-ext.md) is the concentration-driven counterpart to this emissions-driven experiment.
...
esgpull add --track --tag ${EXPERIMENT_NAME} source_id:CR-esm-hl-ext-1-1-0,IIASA-IAMC-1-1-1,IIASA-IAMC-hl-ext-1-1-1,IIASA-IAMC-hl-ext-1-1-2,PIK-esm-hl-ext-1-0-0,SOLARIS-HEPPA-ScenarioMIP-4-6
