---
layout: default
title: "Experiment Setup and Forcings Guidance: scen7-l"
---
...
The scen7-l experiment branches from the [historical](./historical.md) experiment (part of [CMIP](./index.md#cmip)).
...
The scen7-l experiment is a transient forcings experiment.
...
- anthropogenic emissions
    ...
    - notes: the aviation emissions should come from `IIASA-IAMC-l-1-1-2`.
      ...
      simulations based on `IIASA-IAMC-l-1-1-1`, you do not need to re-run them (but note that the extensions emissions
...
- greenhouse gas concentrations
    - recommended source IDs: CR-l-1-1-0
    - further guidance:
...
- population density
    - recommended source IDs: PIK-l-1-0-0
    - further guidance:
