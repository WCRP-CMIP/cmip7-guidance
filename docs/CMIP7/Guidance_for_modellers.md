...
- [Definition of CMIP7 netCDF Global Attributes](https://doi.org/10.5281/zenodo.17250296), which includes specifications for file names and directory structures
- [Reference "controlled vocabularies" (CVs) for CMIP7](https://github.com/WCRP-CMIP/CMIP7-CVs)
- [Guidance on output grids](https://doi.org/10.5281/zenodo.15697024)
...
For CMIP7, the CMOR library has been updated in line with the changes to the [CMIP7 Global Attributes](https://doi.org/10.5281/zenodo.17250296). 
