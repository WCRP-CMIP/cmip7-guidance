...
This repo uses [pre-commit](https://pre-commit.com/) to lint markdown before each commit.
...
- **markdownlint-cli2** — checks list indentation, heading levels, and other markdown style issues. Configuration is in [`.markdownlint.yml`](../.markdownlint.yml) at the repo root.
